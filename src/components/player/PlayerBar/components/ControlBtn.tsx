...
const PlayPrevBtn = () => {
  ...
  return (
    <TouchableOpacity style={{ ...styles.cotrolBtn, ...iosIconButtonShadowReset }} activeOpacity={0.5} onPress={handlePlayPrev}>
...
const PlayNextBtn = () => {
  ...
  return (
    <TouchableOpacity style={{ ...styles.cotrolBtn, ...iosIconButtonShadowReset }} activeOpacity={0.5} onPress={handlePlayNext}>
...
const TogglePlayBtn = () => {
  ...
  return (
    <TouchableOpacity style={{ ...styles.cotrolBtn, ...iosIconButtonShadowReset }} activeOpacity={0.5} onPress={togglePlay}>
